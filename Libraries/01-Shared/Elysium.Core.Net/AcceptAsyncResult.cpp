...
Elysium::Core::Net::Sockets::AcceptAsyncResult::AcceptAsyncResult(Elysium::Core::Net::Sockets::Socket& Socket, const Elysium::Core::Template::Container::Delegate<void, const IAsyncResult*>& Callback, const void* AsyncState, const Elysium::Core::size BufferSize)
