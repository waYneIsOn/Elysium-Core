...
Elysium::Core::IO::BinaryReader::BinaryReader(Stream& BaseStream, const Elysium::Core::Text::Encoding& Encoding, const bool LeaveOpen)
...
const Elysium::Core::byte Elysium::Core::IO::BinaryReader::ReadByte()
{
	...
	_BaseStream.Read(&Result, 1);

	return Result;
}

const Elysium::Core::Collections::Template::Array<Elysium::Core::byte> Elysium::Core::IO::BinaryReader::ReadBytes(const Elysium::Core::uint32_t Count)
{
