...
DBTYPEENUM Elysium::Core::Data::SqlNativeClient::OleDb::FormatConverter::Translate(DbType DbType)
{
	...
	default:
		throw NotImplementedException("unhandled DbType in DBTYPEENUM Elysium::Core::Data::SqlNativeClient::OleDb::FormatConverter::Translate(DbType DbType)");
	}
}
...
DBPARAMIOENUM Elysium::Core::Data::SqlNativeClient::OleDb::FormatConverter::Translate(ParameterDirection ParameterDirection)
{
	...
	case ParameterDirection::ReturnValue:
		...
		*/
	default:
		throw NotImplementedException("unhandled ParameterDirection in DBPARAMIOENUM Elysium::Core::Data::SqlNativeClient::OleDb::FormatConverter::Translate(ParameterDirection ParameterDirection)");
	}
}
