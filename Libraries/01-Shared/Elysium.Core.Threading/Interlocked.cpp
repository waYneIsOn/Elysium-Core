...
Elysium::Core::int32_t Elysium::Core::Threading::Interlocked::Add(int32_t & Location, int32_t Value)
{
...
Elysium::Core::int32_t Elysium::Core::Threading::Interlocked::Decrement(int32_t & Location)
{
	assert(sizeof(long) == sizeof(int32_t));
...
Elysium::Core::int32_t Elysium::Core::Threading::Interlocked::Increment(int32_t & Location)
{
	assert(sizeof(long) == sizeof(int32_t));
