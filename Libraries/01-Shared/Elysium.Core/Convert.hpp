...
namespace Elysium::Core
{
	...
	public:
		...
		static const Elysium::Core::String ToString(Elysium::Core::int8_t Value, const Elysium::Core::uint8_t ToBase);
		static const Elysium::Core::String ToString(Elysium::Core::int8_t Value);
