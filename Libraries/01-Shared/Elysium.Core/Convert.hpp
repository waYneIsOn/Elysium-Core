...
namespace Elysium::Core
{
	...
	public:
		...
		static Elysium::Core::uint16_t ToUInt16(const char8_t* Value, const Elysium::Core::size Length, const Elysium::Core::uint8_t FromBase);
	...
	private:
		...
		static const Elysium::Core::uint16_t ToUInt16FromBase10(const char8_t* Value, const Elysium::Core::size Length);

		static const Elysium::Core::uint16_t ToUInt16FromBase16(const char8_t* Value, const Elysium::Core::size Length);
