...
Elysium::Core::AggregateException::AggregateException(Elysium::Core::Utf8String::ConstCharacterPointer Message)
	: Elysium::Core::Exception(Message)
{ }

Elysium::Core::AggregateException::AggregateException(Utf8String&& Message)
