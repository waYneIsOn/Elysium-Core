...
Elysium::Core::Internal::AsyncResult::AsyncResult(const Elysium::Core::Template::Container::Delegate<void, const Elysium::Core::IAsyncResult*>& Callback, const void* AsyncState, const Elysium::Core::size Position)
...
const Elysium::Core::Template::Container::Delegate<void, const Elysium::Core::IAsyncResult*>& Elysium::Core::Internal::AsyncResult::GetCallback() const
{
	return _Callback;
}
