...
Elysium::Core::Security::Cryptography::Encoding::Asn1::Asn1Integer::Asn1Integer(const Asn1Identifier & Identifier, const Math::Numerics::BigInteger & Value)
	: Elysium::Core::Security::Cryptography::Encoding::Asn1::Asn1Numeric::Asn1Numeric(Identifier),
