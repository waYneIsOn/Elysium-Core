...
Elysium::Core::Security::Cryptography::Encoding::Asn1::Asn1Identifier Elysium::Core::Security::Cryptography::Encoding::Asn1::DERDecoder::DecodeIdentifier(const Elysium::Core::Container::VectorOfByte& Data, const Elysium::Core::size Offset, const Elysium::Core::size Length)
{
	return DecodeIdentifier(&Data[Offset], Length);
}

Elysium::Core::Security::Cryptography::Encoding::Asn1::Asn1Identifier Elysium::Core::Security::Cryptography::Encoding::Asn1::DERDecoder::DecodeIdentifier(const byte * Data, const Elysium::Core::size Length)
{
...
Elysium::Core::Security::Cryptography::Encoding::Asn1::Asn1Length Elysium::Core::Security::Cryptography::Encoding::Asn1::DERDecoder::DecodeLength(const Elysium::Core::Container::VectorOfByte& Data, const Elysium::Core::size Offset, const Elysium::Core::size Length)
{
	IO::MemoryStream InputStream = IO::MemoryStream(Data, Offset, Length);
	return DecodeLength(InputStream);
}

Elysium::Core::Security::Cryptography::Encoding::Asn1::Asn1Length Elysium::Core::Security::Cryptography::Encoding::Asn1::DERDecoder::DecodeLength(const byte * Data, const Elysium::Core::size Length)
{
	IO::MemoryStream InputStream = IO::MemoryStream(Data, Length);
	return DecodeLength(InputStream);
}
...
Elysium::Core::Security::Cryptography::Encoding::Asn1::Asn1ByteArray Elysium::Core::Security::Cryptography::Encoding::Asn1::DERDecoder::DecodeByteArray(const Asn1Identifier& Asn1Identifier, const Asn1Length& Asn1Length, const Elysium::Core::Container::VectorOfByte& Data, const Elysium::Core::size Offset, const Elysium::Core::size Length)
{
	IO::MemoryStream InputStream = IO::MemoryStream(Data, Offset, Length);
	return DecodeByteArray(Asn1Identifier, Asn1Length, InputStream);
}

Elysium::Core::Security::Cryptography::Encoding::Asn1::Asn1ByteArray Elysium::Core::Security::Cryptography::Encoding::Asn1::DERDecoder::DecodeByteArray(const Asn1Identifier& Asn1Identifier, const Asn1Length& Asn1Length, const byte* Data, const Elysium::Core::size Length)
{
	IO::MemoryStream InputStream = IO::MemoryStream(Data, Length);
	return DecodeByteArray(Asn1Identifier, Asn1Length, InputStream);
}
...
Elysium::Core::Security::Cryptography::Encoding::Asn1::Asn1Boolean Elysium::Core::Security::Cryptography::Encoding::Asn1::DERDecoder::DecodeBoolean(const Asn1Identifier & Asn1Identifier, const Asn1Length & Asn1Length, const Elysium::Core::Container::VectorOfByte& Data, const Elysium::Core::size Offset, const Elysium::Core::size Length)
{
	IO::MemoryStream InputStream = IO::MemoryStream(Data, Offset, Length);
	return DecodeBoolean(Asn1Identifier, Asn1Length, InputStream);
}

Elysium::Core::Security::Cryptography::Encoding::Asn1::Asn1Boolean Elysium::Core::Security::Cryptography::Encoding::Asn1::DERDecoder::DecodeBoolean(const Asn1Identifier & Asn1Identifier, const Asn1Length & Asn1Length, const byte * Data, const Elysium::Core::size Length)
{
	IO::MemoryStream InputStream = IO::MemoryStream(Data, Length);
	return DecodeBoolean(Asn1Identifier, Asn1Length, InputStream);
}
...
Elysium::Core::Security::Cryptography::Encoding::Asn1::Asn1Boolean Elysium::Core::Security::Cryptography::Encoding::Asn1::DERDecoder::DecodeBoolean(const Asn1Identifier & Asn1Identifier, const Asn1Length & Asn1Length, IO::Stream & InputStream)
{
	...
	if (Asn1Length.GetLength() > 0)
	{
		...
		Elysium::Core::Container::VectorOfByte Data = Elysium::Core::Container::VectorOfByte(Asn1Length.GetLength());
		Elysium::Core::size TotalBytesRead = 0;
		while (TotalBytesRead < Data.GetLength())
		{
			Elysium::Core::size BytesRead = InputStream.Read(&Data[TotalBytesRead], Data.GetLength() - TotalBytesRead);
			if (BytesRead < 0)
			{
				throw IO::EndOfStreamException();
			}
...
Elysium::Core::Security::Cryptography::Encoding::Asn1::Asn1Integer Elysium::Core::Security::Cryptography::Encoding::Asn1::DERDecoder::DecodeInteger(const Asn1Identifier & Asn1Identifier, const Asn1Length & Asn1Length, const Elysium::Core::Container::VectorOfByte& Data, const Elysium::Core::size Offset, const Elysium::Core::size Length)
{
	IO::MemoryStream InputStream = IO::MemoryStream(Data, Offset, Length);
	return DecodeInteger(Asn1Identifier, Asn1Length, InputStream);
}

Elysium::Core::Security::Cryptography::Encoding::Asn1::Asn1Integer Elysium::Core::Security::Cryptography::Encoding::Asn1::DERDecoder::DecodeInteger(const Asn1Identifier & Asn1Identifier, const Asn1Length & Asn1Length, const byte * Data, const Elysium::Core::size Length)
{
	IO::MemoryStream InputStream = IO::MemoryStream(Data, Length);
	return DecodeInteger(Asn1Identifier, Asn1Length, InputStream);
}
...
Elysium::Core::Security::Cryptography::Encoding::Asn1::Asn1Integer Elysium::Core::Security::Cryptography::Encoding::Asn1::DERDecoder::DecodeInteger(const Asn1Identifier & Asn1Identifier, const Asn1Length & Asn1Length, IO::Stream & InputStream)
{
	...
	else
	{
		...
		Math::Numerics::BigInteger32 Value = (FirstByteValue & 0x80) != 0 ? Math::Numerics::BigInteger32(-1) : Math::Numerics::BigInteger32(0);
...
Elysium::Core::Security::Cryptography::Encoding::Asn1::Asn1ObjectIdentifier Elysium::Core::Security::Cryptography::Encoding::Asn1::DERDecoder::DecodeObjectIdentifier(const Asn1Identifier & Asn1Identifier, const Asn1Length & Asn1Length, const Elysium::Core::Container::VectorOfByte& Data, const Elysium::Core::size Offset, const Elysium::Core::size Length)
{
	IO::MemoryStream InputStream = IO::MemoryStream(Data, Offset, Length);
	return DecodeObjectIdentifier(Asn1Identifier, Asn1Length, InputStream);
}

Elysium::Core::Security::Cryptography::Encoding::Asn1::Asn1ObjectIdentifier Elysium::Core::Security::Cryptography::Encoding::Asn1::DERDecoder::DecodeObjectIdentifier(const Asn1Identifier & Asn1Identifier, const Asn1Length & Asn1Length, const byte * Data, const Elysium::Core::size Length)
{
	IO::MemoryStream InputStream = IO::MemoryStream(Data, Length);
	return DecodeObjectIdentifier(Asn1Identifier, Asn1Length, InputStream);
}
...
Elysium::Core::Security::Cryptography::Encoding::Asn1::Asn1ObjectIdentifier Elysium::Core::Security::Cryptography::Encoding::Asn1::DERDecoder::DecodeObjectIdentifier(const Asn1Identifier& Asn1Identifier, const Asn1Length& Asn1Length, IO::Stream& InputStream)
{
	...
	return Elysium::Core::Security::Cryptography::Encoding::Asn1::Asn1ObjectIdentifier(Asn1Identifier, 
		Elysium::Core::Security::Cryptography::Oid::FromOidValue(OidBuilder.ToString(), Elysium::Core::Template::Security::Cryptography::Encoding::OidGroup::All));
}

Elysium::Core::Security::Cryptography::Encoding::Asn1::Asn1Utf8String Elysium::Core::Security::Cryptography::Encoding::Asn1::DERDecoder::DecodeString(const Asn1Identifier & Asn1Identifier, const Asn1Length & Asn1Length, const Elysium::Core::Container::VectorOfByte& Data, const Elysium::Core::size Offset, const Elysium::Core::size Length)
{
	IO::MemoryStream InputStream = IO::MemoryStream(Data, Offset, Length);
	return DecodeString(Asn1Identifier, Asn1Length, InputStream);
}

Elysium::Core::Security::Cryptography::Encoding::Asn1::Asn1Utf8String Elysium::Core::Security::Cryptography::Encoding::Asn1::DERDecoder::DecodeString(const Asn1Identifier & Asn1Identifier, const Asn1Length & Asn1Length, const byte * Data, const Elysium::Core::size Length)
{
	IO::MemoryStream InputStream = IO::MemoryStream(Data, Length);
	return DecodeString(Asn1Identifier, Asn1Length, InputStream);
}

Elysium::Core::Security::Cryptography::Encoding::Asn1::Asn1Utf8String Elysium::Core::Security::Cryptography::Encoding::Asn1::DERDecoder::DecodeString(const Asn1Identifier & Asn1Identifier, const Asn1Length & Asn1Length, IO::Stream & InputStream)
{
...
Elysium::Core::Security::Cryptography::Encoding::Asn1::Asn1DateTime Elysium::Core::Security::Cryptography::Encoding::Asn1::DERDecoder::DecodeDateTime(const Asn1Identifier& Asn1Identifier, const Asn1Length& Asn1Length, const Elysium::Core::Container::VectorOfByte& Data, const Elysium::Core::size Offset, const Elysium::Core::size Length)
{
	IO::MemoryStream InputStream = IO::MemoryStream(Data, Offset, Length);
	return DecodeDateTime(Asn1Identifier, Asn1Length, InputStream);
}

Elysium::Core::Security::Cryptography::Encoding::Asn1::Asn1DateTime Elysium::Core::Security::Cryptography::Encoding::Asn1::DERDecoder::DecodeDateTime(const Asn1Identifier& Asn1Identifier, const Asn1Length& Asn1Length, const byte* Data, const Elysium::Core::size Length)
{
	IO::MemoryStream InputStream = IO::MemoryStream(Data, Length);
	return DecodeDateTime(Asn1Identifier, Asn1Length, InputStream);
}
...
const Elysium::Core::size Elysium::Core::Security::Cryptography::Encoding::Asn1::DERDecoder::DecodeIdentifierTagNumber(IO::Stream & InputStream, Elysium::Core::int32_t& EncodedLength)
{
	Elysium::Core::size TagNumber = 0;
	while (true)
	{
