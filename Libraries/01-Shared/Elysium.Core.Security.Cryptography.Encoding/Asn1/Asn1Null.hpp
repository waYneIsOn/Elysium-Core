...
#include "../../Elysium.Core.Template/Security/Cryptography/Encoding/Asn1/Asn1Null.hpp"
#endif

namespace Elysium::Core::Security::Cryptography::Encoding::Asn1
{
	class ELYSIUM_CORE_SECURITY_API Elysium::Core::Template::Security::Cryptography::Encoding::Asn1::Asn1Null;

	using Asn1Null = Elysium::Core::Template::Security::Cryptography::Encoding::Asn1::Asn1Null;
}
#endif
