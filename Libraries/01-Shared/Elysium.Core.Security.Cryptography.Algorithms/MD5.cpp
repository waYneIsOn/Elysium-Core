...
const Elysium::Core::Container::VectorOfUInt32_t& Elysium::Core::Security::Cryptography::MD5::S()
{
	static const Elysium::Core::Container::VectorOfUInt32_t Value = Elysium::Core::Container::VectorOfUInt32_t(
		{
...
const Elysium::Core::Container::VectorOfUInt32_t& Elysium::Core::Security::Cryptography::MD5::M()
{
	static const Elysium::Core::Container::VectorOfUInt32_t Value = Elysium::Core::Container::VectorOfUInt32_t(
		{
