...
#define ELYSIUM_CORE_SECURITY_CRYPTOGRAPHY_ASN1_ASN1OBJECTIDENTIFIER
...
namespace Elysium::Core::Security::Cryptography::Asn1
{
	...
	public:
		...
		Asn1ObjectIdentifier(const Asn1ObjectIdentifier& Source) = delete;
		Asn1ObjectIdentifier(Asn1ObjectIdentifier&& Right) noexcept = delete;
		virtual ~Asn1ObjectIdentifier();

		Asn1ObjectIdentifier& operator=(const Asn1ObjectIdentifier& Source) = delete;
		Asn1ObjectIdentifier& operator=(Asn1ObjectIdentifier&& Right) noexcept = delete;
