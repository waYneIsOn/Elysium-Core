...
#define ELYSIUM_CORE_TEMPLATE_IO_FILEOPTIONS
...
#error "undefined os"
	...
	{
		return static_cast<FileOptions>(static_cast<Elysium::Core::Template::System::uint32_t>(Left) | static_cast<Elysium::Core::Template::System::uint32_t>(Right));
	}
