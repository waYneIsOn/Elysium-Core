...
===========================================================================
*/
#ifndef ELYSIUM_CORE_TEMPLATE_IO_SOURCE_POLICY_BLOCKINGPOLICY
#define ELYSIUM_CORE_TEMPLATE_IO_SOURCE_POLICY_BLOCKINGPOLICY
	...
	public:
		...
		inline const Elysium::Core::Template::IO::ReadResult ReadBlock(DeviceType& Device, Elysium::Core::Template::Container::View::Span<Elysium::Core::Template::System::byte>& DataView)
		{
			while (true)
			{
				...
				const Elysium::Core::Template::IO::ReadResult Result = _Device.ReadBlock(Span);

				if (Elysium::Core::Template::IO::ReadResult::WouldBlock != Result)
				{
					return Result;
				}
			}
