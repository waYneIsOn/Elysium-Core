...
#define ELYSIUM_CORE_TEMPLATE_SECURITY_CRYPTOGRAPHY_CHECKSUM_CRC32
...
namespace Elysium::Core::Template::Security::Cryptography::Checksum
{
	...
	public:
		inline static const Elysium::Core::Template::System::uint32_t CalculateBytewise(const Elysium::Core::Template::System::byte* Data,
			const Elysium::Core::Template::System::size Length) noexcept
		{
			...
			Elysium::Core::Template::System::uint32_t Checksum = 0xFFFFFFFF;
			Elysium::Core::Template::System::uint32_t LookupTableIndex;
	...
	private:
		// Todd K. Moon, "Error Correction Coding. Mathematical Methods and Algorithms", Wiley, 2005, ISBN 0-471-64800-0
		inline static constexpr const Elysium::Core::Template::System::uint32_t _LookupTable[256] =
		{
