...
===========================================================================
*/
#ifndef ELYSIUM_CORE_TEMPLATE_SECURITY_CRYPTOGRAPHY_ENCODING_ASN1_XERDECODER
#define ELYSIUM_CORE_TEMPLATE_SECURITY_CRYPTOGRAPHY_ENCODING_ASN1_XERDECODER
...
{
	/// <summary>
	/// "XML Encoding Rules" Decoder
	/// 
	/// Subsets:
	/// - CXER (Canonical XER)
	/// - EXER (Extended XER)
	/// </summary>
	class XERDecoder final
	{
	public:
		constexpr XERDecoder() = default;

		constexpr XERDecoder(const XERDecoder& Source) = default;

		constexpr XERDecoder(XERDecoder&& Right) noexcept = default;

		constexpr ~XERDecoder() = default;
	public:
		constexpr XERDecoder& operator=(const XERDecoder& Source) = default;

		constexpr XERDecoder& operator=(XERDecoder&& Right) noexcept = default;
	public:
