...
===========================================================================
*/
#ifndef ELYSIUM_CORE_TEMPLATE_SECURITY_CRYPTOGRAPHY_ENCODING_ASN1_PERDECODER
#define ELYSIUM_CORE_TEMPLATE_SECURITY_CRYPTOGRAPHY_ENCODING_ASN1_PERDECODER
...
namespace Elysium::Core::Template::Security::Cryptography::Encoding::Asn1
{
	...
	/// - canonical variants
	/// </summary>
	class PERDecoder final
	{
	public:
		constexpr PERDecoder() = default;

		constexpr PERDecoder(const PERDecoder& Source) = default;

		constexpr PERDecoder(PERDecoder&& Right) noexcept = default;

		constexpr ~PERDecoder() = default;
	public:
		constexpr PERDecoder& operator=(const PERDecoder& Source) = default;

		constexpr PERDecoder& operator=(PERDecoder&& Right) noexcept = default;
	public:
