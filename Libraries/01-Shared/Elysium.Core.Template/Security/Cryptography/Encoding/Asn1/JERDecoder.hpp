...
===========================================================================
*/
#ifndef ELYSIUM_CORE_TEMPLATE_SECURITY_CRYPTOGRAPHY_ENCODING_ASN1_JERDECODER
#define ELYSIUM_CORE_TEMPLATE_SECURITY_CRYPTOGRAPHY_ENCODING_ASN1_JERDECODER
...
{
	/// <summary>
	/// "JSON Encoding Rules" Decoder
	/// </summary>
	class JERDecoder final
	{
	public:
		constexpr JERDecoder() = default;

		constexpr JERDecoder(const JERDecoder& Source) = default;

		constexpr JERDecoder(JERDecoder&& Right) noexcept = default;

		constexpr ~JERDecoder() = default;
	public:
		constexpr JERDecoder& operator=(const JERDecoder& Source) = default;

		constexpr JERDecoder& operator=(JERDecoder&& Right) noexcept = default;
	public:
