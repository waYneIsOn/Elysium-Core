...
#define ELYSIUM_CORE_TEMPLATE_SECURITY_CRYPTOGRAPHY_X509CERTIFICATES_X509VERIFICATIONFLAGS
...
#error "undefined os"
	...
	inline X509VerificationFlags operator|(const X509VerificationFlags Left, const X509VerificationFlags Right)
	{
		return static_cast<X509VerificationFlags>(static_cast<Elysium::Core::Template::System::uint32_t>(Left) | static_cast<Elysium::Core::Template::System::uint32_t>(Right));
	}
