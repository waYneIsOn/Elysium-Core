...
#define ELYSIUM_CORE_TEMPLATE_SECURITY_AUTHENTICATION_TLSPROTOCOL
...
#error "undefined os"
	...
	{
		return static_cast<TlsProtocols>(static_cast<Elysium::Core::Template::System::uint16_t>(Left) | static_cast<Elysium::Core::Template::System::uint16_t>(Right));
	}
