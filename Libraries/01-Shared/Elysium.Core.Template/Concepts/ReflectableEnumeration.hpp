...
namespace Elysium::Core::Template::Concepts
{
	...
	///		- it's an actual enum
	///		- the size of the underlying type is 16 bit or less 
	///		  (since there currently is no compiler magic available, I have to create this limit!)
	///			@ToDo:
	///				check this when using newer c++ compilers. c++26 onwards hopefully might have what I'm looking for!
