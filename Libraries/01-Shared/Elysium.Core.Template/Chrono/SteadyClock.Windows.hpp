...
#define ELYSIUM_CORE_TEMPLATE_CHRONO_STEADYCLOCK_WINDOWS
...
#undef ELYSIUM_CORE_ARCHITECTURE_LIKELY_X86
    ...
    private:
        inline static const Elysium::Core::Template::System::int64_t GetPerformanceFrequency() noexcept
        {
        ...
        inline static const Elysium::Core::Template::System::int64_t GetPerformanceCounter() noexcept
        {
