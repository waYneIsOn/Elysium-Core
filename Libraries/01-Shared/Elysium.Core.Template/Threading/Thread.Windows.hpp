...
#define ELYSIUM_CORE_TEMPLATE_THREADING_THREAD_WINDOWS
...
namespace Elysium::Core::Template::Threading
{
	...
	public:
		...
		template <class F, class... Args>
			requires Elysium::Core::Template::Concepts::Something<T>
		void Start(F&& Function, Args&& Parameters)
		{

		}
		*/
		template <class... Args>
		inline void Start(Elysium::Core::Template::Container::Function<void(*)(Args...)>&& ThreadStart, Args... Parameters)
		{
		...
		inline void Start(Elysium::Core::Template::Container::Function<void(Type::*)(Args...)>&& ThreadStart, Type& Instance, Args... Parameters){
			{
				if (nullptr != _ThreadHandle)
				{
					return;
		...
		inline void Start(Elysium::Core::Template::Container::Function<L>&& ThreadStart, Args... Parameters)
		{
			if (nullptr != _ThreadHandle)
			{
				return;
	...
	private:
		...
		inline static DWORD StartInternally(void* Parameters) noexcept
		{
			/*
		...
		inline static void InvokeFunction(Elysium::Core::Template::Container::Tuple<FunctionType>& Tuple)
		{
		...
		inline static void InvokeFunction(Elysium::Core::Template::Container::Tuple<FunctionType, Args...>& Tuple, Elysium::Core::Template::Utility::IndexSequence<Index...>)
		{
			FunctionType& Function = Tuple.GetFirst();
