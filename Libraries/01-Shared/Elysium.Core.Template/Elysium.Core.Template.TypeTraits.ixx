...
export
{
	...
	using Elysium::Core::Template::TypeTraits::Disjunction;
	using Elysium::Core::Template::TypeTraits::DisjunctionValue;
	...
	using Elysium::Core::Template::TypeTraits::IsAnyOf;
	using Elysium::Core::Template::TypeTraits::IsArithmetic;
	using Elysium::Core::Template::TypeTraits::IsArray;
	using Elysium::Core::Template::TypeTraits::IsBoolean;
	using Elysium::Core::Template::TypeTraits::IsCharacter;
	using Elysium::Core::Template::TypeTraits::IsClass;
	using Elysium::Core::Template::TypeTraits::IsConstant;
	using Elysium::Core::Template::TypeTraits::IsConvertible;
	using Elysium::Core::Template::TypeTraits::IsCopyAssignable;
	using Elysium::Core::Template::TypeTraits::IsCopyConstructible;
	using Elysium::Core::Template::TypeTraits::IsDerivedFrom;
	using Elysium::Core::Template::TypeTraits::IsEnumeration;
	using Elysium::Core::Template::TypeTraits::IsFlagEnumeration;
	using Elysium::Core::Template::TypeTraits::IsFloatingPoint;
	using Elysium::Core::Template::TypeTraits::IsForwardDeclared;
	using Elysium::Core::Template::TypeTraits::IsFunction;
	using Elysium::Core::Template::TypeTraits::IsFundamental;
	using Elysium::Core::Template::TypeTraits::IsInteger;
	using Elysium::Core::Template::TypeTraits::IsIntegral;
	using Elysium::Core::Template::TypeTraits::IsLambda;
	using Elysium::Core::Template::TypeTraits::IsMemberFunctionPointer;
	using Elysium::Core::Template::TypeTraits::IsMoveAssignable;
	using Elysium::Core::Template::TypeTraits::IsMoveConstructible;
	using Elysium::Core::Template::TypeTraits::IsNoThrowInvocable;
	using Elysium::Core::Template::TypeTraits::IsNoThrowDefaultConstructible;
	using Elysium::Core::Template::TypeTraits::IsNullPointer;
	using Elysium::Core::Template::TypeTraits::IsPointer;
	using Elysium::Core::Template::TypeTraits::IsReference;
	using Elysium::Core::Template::TypeTraits::IsSame;
	using Elysium::Core::Template::TypeTraits::IsScopedEnumeration;
	using Elysium::Core::Template::TypeTraits::IsSigned;
	using Elysium::Core::Template::TypeTraits::IsSignedInteger;
	using Elysium::Core::Template::TypeTraits::IsTrivial;
	using Elysium::Core::Template::TypeTraits::IsTriviallyCopyable;
	using Elysium::Core::Template::TypeTraits::IsUnicodeCharacter;
	using Elysium::Core::Template::TypeTraits::IsUnion;
	using Elysium::Core::Template::TypeTraits::IsUnsignedInteger;
	using Elysium::Core::Template::TypeTraits::IsValue;
	using Elysium::Core::Template::TypeTraits::IsVoid;
	using Elysium::Core::Template::TypeTraits::IsVolatile;
	using Elysium::Core::Template::TypeTraits::Select;
	using Elysium::Core::Template::TypeTraits::UnderlyingType;
	using Elysium::Core::Template::TypeTraits::VoidType;
}
