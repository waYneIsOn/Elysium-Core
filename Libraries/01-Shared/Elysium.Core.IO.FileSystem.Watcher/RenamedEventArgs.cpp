...
Elysium::Core::IO::RenamedEventArgs::RenamedEventArgs(const Elysium::Core::Template::IO::FileSystem::WatcherChangeTypes ChangeType, Utf8String&& FullPath, Utf8String&& Name, Utf8String&& OldName)
