...
Elysium::Core::Math::Numerics::BigInteger::BigInteger(const Elysium::Core::Container::VectorOfUInt32_t& Value, const bool IsNegative)
	: _Sign(0), _Bits(Value)
{
	...
	{	// values like (Int32.MaxValue+1) are stored as "0x80000000" and as such cannot be packed into _sign
		...
		_Bits = Elysium::Core::Container::VectorOfUInt32_t(0);
	...
	else
	{
		...
		_Bits = Elysium::Core::Container::VectorOfUInt32_t(Length);
		Elysium::Core::Template::Algorithms::Copy(&Value[0], &Value[Length - 1], &_Bits[0]);
	}
}

Elysium::Core::Math::Numerics::BigInteger::BigInteger(Elysium::Core::Container::VectorOfUInt32_t& Value)
	: _Sign(0), _Bits(Value)
{ 
	...
	else if (DWordCount == 1)
	{
		...
		{
			_Bits = Elysium::Core::Container::VectorOfUInt32_t(1);
			_Bits[0] = Value[0];
			_Sign = +1;
		}
	...
	else
	{
		if (!IsNegative)
		{
			...
			{
				_Sign = +1;
				_Bits = Elysium::Core::Container::VectorOfUInt32_t(DWordCount);
				Elysium::Core::Template::Algorithms::Copy(&Value[0], &Value[DWordCount - 1], &_Bits[0]);
			}
			else
			{
				_Sign = +1;
...
Elysium::Core::Math::Numerics::BigInteger::BigInteger(const Elysium::Core::int32_t Value)
	...
	_Bits(Value == Elysium::Core::Int32::GetMinValue() ? 0 : 1)
{
...
Elysium::Core::Math::Numerics::BigInteger::BigInteger(const Elysium::Core::uint32_t Value)
	...
	_Bits(Value < Elysium::Core::Int32::GetMaxValue() ? 0 : 1)
{
...
Elysium::Core::Math::Numerics::BigInteger::BigInteger(const Elysium::Core::Container::VectorOfUInt32_t& Value)
	: _Sign(0), _Bits(Value.GetLength() / 4)
{ 
	...
	else
	{
		...
		bool IsZero = true;
		Elysium::Core::Container::VectorOfUInt32_t Val = Elysium::Core::Container::VectorOfUInt32_t(1);
		...
		else if (IsNegative)
		{
			...
			else if (Length != Val.GetLength())
			{
				_Sign = -1;
				_Bits = Elysium::Core::Container::VectorOfUInt32_t(Length);
				Elysium::Core::Template::Algorithms::Copy(&Val[0], &Val[Length - 1], &_Bits[0]);
			}
			else
			{
				_Sign = -1;
...
Elysium::Core::Math::Numerics::BigInteger Elysium::Core::Math::Numerics::BigInteger::operator<<(const Elysium::Core::int32_t & Shift)
{
	...
	Elysium::Core::Container::VectorOfUInt32_t Bits = Elysium::Core::Container::VectorOfUInt32_t(0);
	...
	Elysium::Core::Container::VectorOfUInt32_t zd = Elysium::Core::Container::VectorOfUInt32_t(zl);
...
Elysium::Core::Math::Numerics::BigInteger Elysium::Core::Math::Numerics::BigInteger::operator>>(const Elysium::Core::int32_t & Shift)
{
	...
	if (IsNegative)
	{
		...
		Elysium::Core::Template::Algorithms::Copy(&Bits[0], &Bits[Length - 1], &Temp[0]);
		Bits = Temp;
...
Elysium::Core::Math::Numerics::BigInteger Elysium::Core::Math::Numerics::BigInteger::operator|(const BigInteger & Right)
{
	...
	Elysium::Core::Container::VectorOfUInt32_t x = ToUInt32Array();
	Elysium::Core::Container::VectorOfUInt32_t y = Right.ToUInt32Array();
	Elysium::Core::Container::VectorOfUInt32_t z = Elysium::Core::Container::VectorOfUInt32_t(MathHelper::Max(x.GetLength(), y.GetLength()));
...
const bool Elysium::Core::Math::Numerics::BigInteger::GetPartsForBitManipulation(const BigInteger & Value, Elysium::Core::Container::VectorOfUInt32_t& Bits, Elysium::Core::int32_t& Length)
{
	if (Value._Bits.GetLength() == 0)
	{
		if (Value._Sign < 0)
		{
			Bits = Elysium::Core::Container::VectorOfUInt32_t({ static_cast<uint32_t>(-Value._Sign) });
		}
		else
		{
			Bits = Elysium::Core::Container::VectorOfUInt32_t({ static_cast<uint32_t>(Value._Sign) });
...
const Elysium::Core::Container::VectorOfUInt32_t Elysium::Core::Math::Numerics::BigInteger::DangerousMakeTwosComplement(Elysium::Core::Container::VectorOfUInt32_t& d)
...
const Elysium::Core::Container::VectorOfUInt32_t Elysium::Core::Math::Numerics::BigInteger::Resize(Elysium::Core::Container::VectorOfUInt32_t& Value, const Elysium::Core::int32_t Length)
{
	...
	Elysium::Core::Container::VectorOfUInt32_t Result = Elysium::Core::Container::VectorOfUInt32_t(Length);
...
const Elysium::Core::Container::VectorOfUInt32_t Elysium::Core::Math::Numerics::BigInteger::ToUInt32Array() const
{
	if (_Bits.GetLength() == 0 && _Sign == 0)
	{
		return Elysium::Core::Container::VectorOfUInt32_t({ 0 });
	}

	Elysium::Core::Container::VectorOfUInt32_t DWords = Elysium::Core::Container::VectorOfUInt32_t(0);
	uint32_t HighDWord;

	if (_Bits.GetLength() == 0)
	{
		DWords = Elysium::Core::Container::VectorOfUInt32_t({ static_cast<Elysium::Core::uint32_t>(_Sign) });
	...
	Elysium::Core::Container::VectorOfUInt32_t Trimmed = Elysium::Core::Container::VectorOfUInt32_t(msb + 1 + (NeedExtraByte ? 1 : 0));
	Elysium::Core::Template::Algorithms::Copy(&DWords[0], &DWords[msb], &Trimmed[0]);
