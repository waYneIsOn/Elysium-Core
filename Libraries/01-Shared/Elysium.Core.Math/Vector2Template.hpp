...
namespace Elysium::Core::Math::Numerics
{
	...
	public:
		...
		static Vector2Template<T> UnitX();
		static Vector2Template<T> UnitY();
	...
	template<class T>
	inline Vector2Template<T> Vector2Template<T>::Zero()
	{
		return Vector2Template<T>(static_cast<T>(0));
	}

	template<class T>
	inline Vector2Template<T> Vector2Template<T>::One()
	{
		return Vector2Template<T>(static_cast<T>(1));
	}

	template<class T>
	inline Vector2Template<T> Vector2Template<T>::UnitX()
	{
		return Vector2Template<T>(static_cast<T>(1), static_cast<T>(0));
	}

	template<class T>
	inline Vector2Template<T> Vector2Template<T>::UnitY()
	{
		return Vector2Template<T>(static_cast<T>(0), static_cast<T>(1));
	}
