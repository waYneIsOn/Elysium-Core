...
Elysium::Core::Speech::Synthesis::StateChangedEventArgs::StateChangedEventArgs(String&& Prompt, const SynthesizerState PreviousState, const SynthesizerState State)
