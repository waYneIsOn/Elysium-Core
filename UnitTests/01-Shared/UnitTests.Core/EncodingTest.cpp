...
namespace UnitTests::Core::Text
{
	...
	public:
		TEST_METHOD(Encoding)
		{
			...
			// Unicode
			{
				...
				// UTF-8
				{
					...
					Assert::AreEqual(static_cast<const char>(0x24), Input[0]);

					Assert::AreEqual(static_cast<const char>(0xC2), Input[1]);
					Assert::AreEqual(static_cast<const char>(0xA2), Input[2]);

					Assert::AreEqual(static_cast<const char>(0xE2), Input[3]);
					Assert::AreEqual(static_cast<const char>(0x82), Input[4]);
					Assert::AreEqual(static_cast<const char>(0xAC), Input[5]);

					Assert::AreEqual(static_cast<const char>(0xF0), Input[6]);
					Assert::AreEqual(static_cast<const char>(0x90), Input[7]);
					Assert::AreEqual(static_cast<const char>(0x8D), Input[8]);
					Assert::AreEqual(static_cast<const char>(0x88), Input[9]);

					Assert::AreEqual(static_cast<const char>(0xE0), Input[10]);
					Assert::AreEqual(static_cast<const char>(0xA4), Input[11]);
					Assert::AreEqual(static_cast<const char>(0xB9), Input[12]);
		...
		{
			{
				Elysium::Core::IO::FileStream SourceStream = Elysium::Core::IO::FileStream("Utf8.txt", Elysium::Core::IO::FileMode::Open, Elysium::Core::IO::FileAccess::Read);
		...
		{
			{
				Elysium::Core::IO::FileStream SourceStream = Elysium::Core::IO::FileStream("Utf16LE.txt", Elysium::Core::IO::FileMode::Open, Elysium::Core::IO::FileAccess::Read);
				Elysium::Core::IO::StreamReader Reader = Elysium::Core::IO::StreamReader(SourceStream, Elysium::Core::Text::Encoding::UTF16LE());
			}

			{
				Elysium::Core::IO::FileStream SourceStream = Elysium::Core::IO::FileStream("Utf16BE.txt", Elysium::Core::IO::FileMode::Open, Elysium::Core::IO::FileAccess::Read);
		...
		{
			{
				Elysium::Core::IO::FileStream SourceStream = Elysium::Core::IO::FileStream("Utf32.txt", Elysium::Core::IO::FileMode::Open, Elysium::Core::IO::FileAccess::Read);
