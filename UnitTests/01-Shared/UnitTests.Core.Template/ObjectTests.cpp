...
#include "../../../../Elysium-Core/Libraries/01-Shared/Elysium.Core.Template/Container/Object.hpp"
...
namespace UnitTests::Core::Template::Container
{
	...
	public:
		TEST_METHOD(GetHashCodes)
		{
			...
			const String<char> KeyString = "bla";
			const String<wchar_t> KeyWideString = L"bla";
			const String<char8_t> KeyUtf8String = u8"bla";
			const String<char16_t> KeyUtf16String = u"bla";
			const String<char32_t> KeyUtf32String = U"bla";
